...
if __name__=='__main__':
    ...
    input_data_path = os.path.join('/opt/ml/processing/input', 'data/preprocessing/')
    # Load batch file
    #imgDir = './data/'
    dirlist = os.listdir(input_data_path)
    featureDict = {}
    for ind in range(len(dirlist)):
        path = os.path.join(input_data_path,dirlist[ind])
    ...
    output_path = os.path.join('/opt/ml/processing/train', 'feature.csv')
